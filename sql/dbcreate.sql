...
DROP TABLE IF EXISTS TB_STUDY_GROUP_REQUEST_RESULT RESTRICT;
...
CREATE TABLE tb_group_detail (
  ...
  ID varchar(30) NOT NULL COMMENT '작성자',
  DEL_AT varchar(1) DEFAULT 'N' COMMENT '삭제여부',
  DEL_DT varchar(8) DEFAULT NULL COMMENT '완전 삭제 예정일',
...
CREATE TABLE tb_group_member (
  ...
  DEL_AT varchar(1) DEFAULT 'N' COMMENT '삭제여부',
  DEL_DT varchar(8) DEFAULT NULL COMMENT '완전 삭제 예정일',
  DEL_REASON varchar(30) DEFAULT NULL COMMENT '탈퇴 이유(자진탈퇴(I), 그룹 삭제(Y))',
...
CREATE TABLE tb_group_qna (
  ...
  NEXT_REPLY_AT varchar(2) DEFAULT NULL COMMENT '그룹번호',
...
CREATE TABLE tb_member (
  ...
  UNITY_ID varchar(300) DEFAULT NULL COMMENT '첨부파일 ID',
  REG_DT varchar(8) DEFAULT NULL COMMENT '가입일',
  DEL_AT varchar(1) DEFAULT 'N' COMMENT '삭제여부',
  DEL_DT varchar(8) DEFAULT NULL COMMENT '완전 삭제 예정일',
  PRIMARY KEY (ID)
...
CREATE TABLE tb_study_group (
  ...
  USE_AT varchar(1) DEFAULT NULL COMMENT '사용여부',
  UNITY_GROUP_ID varchar(300) DEFAULT NULL COMMENT '첨부파일 GROUP ID',
  DEL_AT varchar(1) DEFAULT 'N' COMMENT '삭제여부',
  DEL_DT varchar(8) DEFAULT NULL COMMENT '완전 삭제 예정일',
...
CREATE TABLE tb_unity (
  UNITY_ID varchar(150) NOT NULL COMMENT '첨부파일ID',
...
CREATE TABLE tb_unity_group (
  UNITY_GROUP_ID varchar(150) NOT NULL COMMENT '첨부파일 GROUP ID',
  UNITY_ID varchar(150) NOT NULL COMMENT '첨부파일ID',
  DEL_AT varchar(1) DEFAULT 'N' COMMENT '삭제여부',
  DEL_DT varchar(8) DEFAULT NULL COMMENT '완전 삭제 예정일',
